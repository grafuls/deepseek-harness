...
- A deleted collab workspace no longer leaves a Host workspace registration behind, so the local workspace picker and the collab sidebar agree on what still exists.
