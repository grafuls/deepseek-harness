...
- **Dry-run.** `dryRun: true` fetches and computes exactly what would move (branch, base, tips, ahead/behind, links) and returns it without pushing, unauthenticated reads fail openly rather than degrading.
