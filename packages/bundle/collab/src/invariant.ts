/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-collab-bundle`.
 * @module @deepseek-ai/dsh-collab-bundle/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-collab-bundle'

/** Cordis companion plugin name. */
export const name = 'collab-bundle-invariant'
