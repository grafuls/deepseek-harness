...
describe('WorkspacesPanel', () => {
  ...
  it('keeps branch and commit off the workspace rows (a per-session surface now)', () => {
    // Request 2 moved the branch off every workspace surface: even with the
    // wire gitState on the view, the manager list rows must not show it.
