...
export function apply(ctx: ClientContext): void {
  ...
  // The wire answers every settings request itself (authenticator gate +
  // privileged-method pin), and the scope is always host-backed, so the store
  // needs no isLoopback branch of its own.
