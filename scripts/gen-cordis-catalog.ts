...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  agents: 'core.md',
  collabAuth: 'collab.md',
  collabUsers: 'collab.md',
  collabWorkspaces: 'collab.md',
  rbac: 'collab.md',
  apiProxy: 'typert.md',
...
export const TYPE_LINK_EXEMPTIONS: Readonly<Record<string, string>> = {
  ...
  CollabPrincipal: 'collab auth principal is owned by packages/collab/auth/types.ts',
  LoginOutcome: 'collab auth login outcome is owned by packages/collab/auth/types.ts',
  UserId: 'collab user identity is owned by packages/collab/users/types.ts',
  GoogleProfile: 'collab Google identity record is owned by packages/collab/users/types.ts',
  UserProfile: 'collab user profile view is owned by packages/collab/users/types.ts',
  GlobalRole: 'collab global role is owned by packages/collab/rbac/types.ts',
  WorkspaceRole: 'collab workspace role is owned by packages/collab/rbac/types.ts',
  InvitationId: 'collab invitation identity is owned by packages/collab/workspaces/types.ts',
  WorkspaceRecord: 'collab workspace registry record is owned by packages/collab/workspaces/types.ts',
  ...
  CreateWorkspaceOptions: 'collab workspace creation options are owned by packages/collab/workspaces/src/index.ts',
  CloneSettlement: 'collab clone settlement result is owned by packages/collab/workspaces/types.ts',
  ClonedOutcome: 'collab clone settlement input is owned by packages/collab/workspaces/types.ts',
